    ...
    render() {
        return (
            <div className="container-fuild"   >
               ...
               <div className="row topStyle"  >
               <div className="col-md-5 col-xs-5 col-sm-5 col-xl-5 col-lg-5 paperDiv " >
               ...
               <div className="col-md-5 col-xs-5 col-sm-5 col-xl-5 col-lg-5 paperDivTwo" >
