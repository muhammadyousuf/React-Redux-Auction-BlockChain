                        ...
                        <div className="col-md-6"  >
                            <div className="form-group">
                                ...
                                <div className="textBox">
                                    ...
                                    <input type="date" onChange={(event) => { this.setState({ start: event.target.value }) }} className="form-control" id="start" value={this.state.start} placeholder="Start Date" />
                                
                                </div>
                                <div className="textBox">
                                    <label htmlFor="EndDate" className="labelStyle">End Date:</label>
                                    <input type="date" onChange={(event) => { this.setState({ end: event.target.value }) }} className="form-control" id="end" value={this.state.price} placeholder="End Date" />
