                    ...
                    <div className="row">
                        ...
                        <div className="superFooter">
                            <div className="row justify-content-center">
                                ...
                                <div className="col-md-2 col-sm-4 col-xs-5">
                                    <img src="https://www.auctionity.com/wp-content/uploads/2018/09/Groupe-336.png"
                                         className="alignnone size-full wp-image-185 aligncenter imageIconStyle"
                                         alt=""/>
                                    <p className="paraStyle">Open source</p>
                                </div>
                                <div className="col-md-2 col-sm-4 col-xs-5">
                                    <img src="https://www.auctionity.com/wp-content/uploads/2018/09/Groupe-339.png"
                                         alt=""
                                         className="alignnone size-full wp-image-185 aligncenter imageIconStyle"/>
                                    <p className="paraStyle">Community auctions</p>
                                </div>
                                <div className="col-md-2 col-sm-4 col-xs-5">
                                    <img src="https://www.auctionity.com/wp-content/uploads/2018/09/Groupe-334.png"
                                         alt=""
                                         className="alignnone size-full wp-image-185 aligncenter imageIconStyle"/>
                                    <p className="paraStyle">Free</p>
                                </div>
                                <div className="col-md-2 col-sm-4 col-xs-5">
                                    <img src="https://www.auctionity.com/wp-content/uploads/2018/09/Groupe-345.png"
                                         alt=""
                                         className="alignnone size-full wp-image-185 aligncenter imageIconStyle"/>
                    ...
                    <div className="footer">
                        <div className="row justify-content-center">
                            <div className="col-md-3 col-xs-12 col-sm-6 col-xl-3 col-lg-3">
                                <img src="https://www.auctionity.com/wp-content/uploads/2018/09/m%C3%A9daille_NFT.png"
                                     alt="" className="imgIcon"/>
                                <p className="footerPara">The world’s largest blockchain auction house for
                                    cryptocollectibles. Dapp on Ethereum blockchain to auction NFTs in Ether.</p>
                            </div>
                            {/*<div className="col-md-3 col-xs-12 col-sm-6 col-xl-3 col-lg-3">
