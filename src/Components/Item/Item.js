                        ...
                        <div className="col-md-3 col-sm-6 col-xs-6 "   >
                            ...
                            <br /><br /><br />
                                <div className="form-group  "  >
                                    ...
                                    <input style={{width:150, marginLeft:'50px'}} type="text" className="form-control " id="usr" />
    </div>
                            ...
                            <div className="col-md-7 col-sm-12 col-xs-12 "   >
                                ...
                                <div>
                                    ...
                                    <p>A car (or automobile) is a wheeled motor vehicle used for transportation. Most definitions of car say they run primarily on roads, seat one to eight people, have four tires, and mainly transport people rather than goods. Cars became widely available in the early 20th century</p>
                                </div>
